...
import static com.inceptai.wifiexpert.expert.ExpertChatService.INTENT_NOTIF_SOURCE;
...
public class Utils {
    ...
    public static final String WIFIEXPERT_FLAVOR = "wifiexpert";
    ...
    public static PendingIntent getPendingIntentForNotification(Context context, String source) {
        Intent intent = null;
        intent = new Intent(context, DobbyActivity.class);
