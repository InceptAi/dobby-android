...
import com.inceptai.wifiexpertsystem.expertSystem.inferencing.InferenceMap.Condition;
...
import static com.inceptai.wifiexpertsystem.utils.Utils.convertSignalDbmToPercent;
...
//        return channelString;
    ...
    private static String getSuggestionForCondition(@Condition int condition,
                                                   SuggestionCreatorParams params) {
        ...
        switch (condition) {
            ...
            case Condition.WIFI_CHANNEL_BAD_SIGNAL:
                ...
                baseMessage = "Your signal to your wireless router is weak (about "
                        + convertSignalDbmToPercent(params.wifiGrade.getPrimaryApSignal()) + "/100) " +
    ...
    private static String convertWifiLinkModeToIssueString(@WifiStateData.WifiProblemMode int linkMode) {

        if (linkMode == WifiStateData.WifiProblemMode.FREQUENT_DISCONNECTIONS) {
        ...
        switch (linkMode) {
            ...
            case WifiStateData.WifiProblemMode.HANGING_ON_AUTHENTICATING:
                ...
                break;
            case WifiStateData.WifiProblemMode.CONNECTING:
                issuesString += "It is trying to connect to your wifi network but is not yet successful. ";
                break;
            case WifiStateData.WifiProblemMode.DISCONNECTED_PREMATURELY:
                break;
        }
    ...
    private static String getRouterFaultString(SuggestionCreatorParams params) {
        switch (params.wifiGrade.wifiConnectivityMode) {
            case ConnectivityTester.WifiConnectivityMode.ON_AND_DISCONNECTED:
                return convertWifiLinkModeToIssueString(params.wifiGrade.wifiProblemMode);
    ...
    public static String getTitleForCondition(@Condition int condition,
                                                   SuggestionCreatorParams params) {
        StringBuilder suggestionToReturn = new StringBuilder();
        String baseMessage = Utils.EMPTY_STRING;
        String conditionalMessage = Utils.EMPTY_STRING;
    ...
    public static String getShortSuggestionForCondition(@Condition int condition,
                                                        SuggestionCreatorParams params) {
        StringBuilder suggestionToReturn = new StringBuilder();
        String baseMessage = Utils.EMPTY_STRING;
        String conditionalMessage = Utils.EMPTY_STRING;
